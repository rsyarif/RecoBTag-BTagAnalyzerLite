...
const UInt_t nMaxMicroJets_ = 10000; //added by rizki
...
class JetInfoBranches {
  ...
  public :
    ...
    int   Jet_SD_isLeadMicrojetBtag[nMaxJets_]; //added by rizki
    ...
    void RegisterFatJetSpecificTree(TTree *tree, std::string name="") {
      ...
      tree->Branch((name+"Jet_SD_isLeadMicrojetBtag").c_str(),      Jet_SD_isLeadMicrojetBtag      ,(name+"Jet_SD_isLeadMicrojetBtag["+name+"nJet]/I").c_str()); //added by rizki
    ...
    void ReadTree(TTree *tree, std::string name="") {
      ...
      tree->SetBranchAddress((name+"Jet_SD_isLeadMicrojetBtag").c_str(),     Jet_SD_isLeadMicrojetBtag); // added by rizki
