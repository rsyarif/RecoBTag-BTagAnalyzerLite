...
class JetInfoBranches {
  ...
  public :
    ...
    bool  Jet_SD_isLeadMicrojetBtag[nMaxJets_]; //added by rizki
    ...
    void RegisterFatJetSpecificTree(TTree *tree, std::string name="") {
      ...
      tree->Branch((name+"Jet_SD_isLeadMicrojetBtag").c_str(),      Jet_SD_isLeadMicrojetBtag      ,(name+"Jet_SD_isLeadMicrojetBtag["+name+"nJet]/B").c_str()); //added by rizki
    }
